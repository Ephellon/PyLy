...
def fetch_lyrics_data(
    ...
    try:
        fetched = provider.fetch_fn(query, log_fn=log_fn)
...
def _fetch_lrclib(query: str, *, log_fn=None) -> FetchedLyrics | None:
...
def _fetch_musicbrainz(query: str, *, log_fn=None) -> FetchedLyrics | None:
    """
